...
class _DocumentationScreenState extends State<DocumentationScreen> {
  late List<LearningResource> documentationResources;
  ...
  void initState() {
    super.initState();
    // Get only documentation resources
    documentationResources = LearningResourcesSampleData.getAllSampleResources()
        .where((resource) => resource.type == ResourceType.documentation)
        .toList();
    filteredResources = documentationResources;
  }

  void _filterResources() {
    filteredResources = documentationResources.where((resource) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Documentation - ${widget.conceptName}'),
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Found ${filteredResources.length} documentation resources',
            ...
            if (filteredResources.isEmpty)
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildDocumentationCard(context, resource);
                },
              ),
